...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get privacyPolicySummary => 'UmiVPN只在下方按钮开启的情况下收集诊断日志，这些日志不包含您的个人数据。详细的隐私政策请点击下方按钮查看。';
  ...
  @override
  String get contactUsFreely => '如果您在使用UmiVPN的过程中有任何问题，请随时联系我们。';
  ...
  @override
  String get openSourceSoftwareNoticeText => 'UmiVPN使用了以下开源项目：';
  ...
  @override
  String get ruleNameUmiVPNTestNodes => 'UmiVPN节点测试';
  ...
  @override
  String get installAsWinService => '添加UmiVPN进Windows Service';

  @override
  String get installAsWinServiceDesc => '在使用TUN前，需要将UmiVPN添加进Windows Service，点击“添加”以进行添加。';
  ...
  @override
  String get startOnBootDesc => '开机时自动运行UmiVPN';
  ...
  @override
  String get enableSystemExtension => '请前往[系统设置->通用->登录项与扩展->网络扩展]并开启 UmiVPN SystemExtension';
  ...
  @override
  String get nodeSetDesc => '\"__node__\"为包含所有节点域名/IP的域名小集合/IP小集合。它主要被用于让UmiVPN节点测试走直连。节点域名包括它的地址和SNI';

  @override
  String get dnsNameDesc => 'DNS服务器名称可以在入站条件那里引用，以指定它所使用的节点。';

  @override
  String get directAppSetDesc => '在安卓上，直连应用集合内的应用不会经过UmiVPN（Split Tunnel）';
  ...
  String fatalError(String error) {
    return '发生错误。请重启UmiVPN。错误: $error';
  }
  ...
  @override
  String get supportReplied => '客服已回复';

  @override
  String get openSupportChat => '打开';
