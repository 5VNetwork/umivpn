...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get unableToGetNodes => 'Не удалось получить узлы, ваш буфер обмена не содержит URL-адрес подписки, который UmiVPN может проанализировать.';
  ...
  @override
  String get privacyPolicySummary => 'UmiVPN собирает журналы диагностики только при включенном переключателе ниже. Эти журналы не содержат персональных данных. Нажмите кнопку ниже, чтобы ознакомиться с подробной политикой конфиденциальности.';
  ...
  @override
  String get tunNeedAdmin => 'Чтобы использовать tun, перезапустите UmiVPN от имени администратора.';
  ...
  @override
  String get ruleNameUmiVPNTestNodes => 'Тестирование узла UmiVPN';
  ...
  @override
  String get debugLogDesc => 'Если у вас возникли проблемы при использовании UmiVPN, вы можете включить кнопку и дождаться повторного возникновения проблемы, затем нажать кнопку «Загрузить», чтобы загрузить логи. Не забудьте закрыть её и удалить логи после загрузки. Журналы разработчика не загружаются автоматически, поскольку содержат информацию о вашей сетевой активности, включая используемые вами веб-сайты и приложения. Мы удаляем логи сразу после их обработки.';
  ...
  @override
  String get installAsWinService => 'Добавить UmiVPN в службу Windows';

  @override
  String get installAsWinServiceDesc => 'Перед использованием TUN необходимо добавить UmiVPN в службу Windows. Нажмите «Да», чтобы установить UmiVPN как службу. Для этого потребуется дать разрешение в следующем окне запроса UAC.';
  ...
  @override
  String get startOnBootDesc => 'Запускать UmiVPN автоматически при запуске';
  ...
  @override
  String get enableSystemExtension => 'Включите UmiVPN SystemExtension, перейдя в Системные настройки -> Общие -> Элементы входа и расширения -> Сетевые расширения.';
  ...
  @override
  String get directAppSetDesc => 'На Android приложения из набора прямых приложений не будут проходить через UmiVPN (разделенный туннель)';
  ...
  String fatalError(String error) {
    return 'Произошла ошибка. Перезапустите UmiVPN. Ошибка: $error';
  }
  ...
  String insertDefaultError(String error) {
    return 'Не удалось вставить данные по умолчанию. Перезапустите UmiVPN и добавьте их на страницу маршрутизации. Причина: $error';
  }
